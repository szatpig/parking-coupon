        ...
        <div class="coupon-car-list">
            <template v-for="item in carList">
                <div class="car-cell flex" :class="{ active: item.unReceivedCount }">
                    ...
                    <van-button v-else round size="small" @click="$router.push('/home/user/coupons?plateNo='+item.plateNo+ '&plateColor='+item.plateColor)">查看全部<van-icon name="arrow" /></van-button>
                </div>
            </template>
